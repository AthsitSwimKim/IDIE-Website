...
export function ProductCard({ product }: ProductCardProps) {
  ...
  return (
    ...
    >
      ...
      */}
      {/*
        จองที่ไว้สองบรรทัดเฉพาะจอมือถือ — การ์ดกว้าง 156px ทำให้รหัสรุ่นที่ยาวอย่าง
        "GNExB2X21 48 V DC / 230 V AC" ตกเป็นสองบรรทัดในเม็ดยา (สูง 47px แทน 26px)
        ใบข้างเคียงที่รหัสสั้นจึงดันชื่อสินค้าขึ้นไปสูงกว่าเพื่อน 21px

        ใช้ calc(2lh + 6px) ไม่ใช่ค่าพิกเซลตายตัว — 2lh คือสองบรรทัดของตัวอักษรขนาด
        เดียวกับในเม็ดยา บวกระยะขอบบน-ล่าง 4px กับเส้นขอบ 2px ค่าจึงปรับตามภาษาเอง
        (ไทยได้ 47.6px อังกฤษได้ 40.7px เพราะระยะบรรทัดของสองภาษาต่างกัน)
        ต้องมี text-xs ที่ตัวครอบด้วย ไม่งั้น lh จะอ้างระยะบรรทัดของการ์ดแทนของเม็ดยา

        sm:min-h-0 ปลดออกตั้งแต่จอ 640 ขึ้นไป — ที่นั่นการ์ดกว้างพอให้รหัสอยู่บรรทัดเดียว
        เสมอ การจองที่จะกลายเป็นช่องว่างเปล่าโดยไม่ได้แก้อะไร
      */}
      <span className="mt-3 block min-h-[calc(2lh_+_6px)] text-xs sm:min-h-0">
        {/*
