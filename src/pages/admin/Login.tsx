    ...
    <div className="bg-surface-alt grid min-h-dvh place-items-center p-6">
      <div className="border-line bg-surface rounded-card w-full max-w-md border p-8">
        ...
        */}
        ...
        {/*
          ไม่มีปุ่ม “ลืมรหัสผ่าน” ให้กดเอง เพราะระบบไม่ได้ส่งอีเมลรีเซ็ต — ปุ่มที่กดแล้ว
          ไม่เกิดอะไรแย่กว่าการบอกตรง ๆ ว่าต้องทำอย่างไร ข้อความนี้จึงเขียนถึงทั้งสองกรณี
          คือยังมีเพื่อนร่วมทีมช่วยได้ กับเหลือคนเดียวจนต้องพึ่งเครื่องเซิร์ฟเวอร์
        */}
