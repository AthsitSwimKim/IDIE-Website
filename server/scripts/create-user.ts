 ...
 *
 * **ไม่ทำหน้าสมัครสมาชิกบนเว็บโดยตั้งใจ** — ระบบนี้มีผู้ใช้ไม่กี่คนและทุกคน
 * สิทธิ์เท่ากัน หน้าสมัครที่เปิดทิ้งไว้บนอินเทอร์เน็ตคือช่องให้ใครก็ได้สร้างบัญชี
 * ที่แก้เนื้อหาเว็บบริษัทได้ การสร้างบัญชีจึงต้องมีสิทธิ์เข้าถึงเครื่องเซิร์ฟเวอร์
 *
